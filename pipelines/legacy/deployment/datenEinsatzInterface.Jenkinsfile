...
def run_DatenEinsatz_pipeline(run_pipeline, abo, nvs, tpo, env_matrix,
    ...
    def tpo_data_deployment = false
    def bibe_data_deployment = false
    def compare_data = false
    ...
    if (run_pipeline) {
        pman_explicit = true
        tpo_data_deployment = true
        bibe_data_deployment = true
        compare_data = true
    }

    println 'DEBUG: ======================     run Dateneinsatz     ========================='
    println "Deployment of ${params.packages} on ${params.environments}"
...
*/
    ...
    if (run_pipeline) {
        ...
        println "Run in dry-mode! Set run_pipeline to activate deployment."
    }
    }
