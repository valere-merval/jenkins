...
properties([
    ...
    ''']]],
        ...
        booleanParam(name: 'bibe_data_deployment', defaultValue: false, description: 'Toggle this on if you want  start deploying data into bibe psx envinroment, recommend only if data deployment is stable'),
        booleanParam(name: 'tpo_data_deployment', defaultValue: false, description: 'Toggle this on if you want  start deploying data into tpo psx envinroment, recommend only if data deployment is stable'),
        booleanParam(name: 'compare_data', defaultValue: false, description: 'Toggle this on if you want  start comparing actual data packets on bibe and tpo psx envinroment, recommend only if data deployment is stable'),
